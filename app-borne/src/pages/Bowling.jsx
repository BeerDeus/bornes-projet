// Module Bowling (Phase 1, porté depuis test-client/index.html) - permet de
// continuer à tester le bot Conqueror (nouvelle partie, tarifs par joueur,
// paiement CE) directement depuis cette app, en plus/à la place de l'ancien
// test-client HTML, en attendant la vraie interface bowling (Phase 4).
